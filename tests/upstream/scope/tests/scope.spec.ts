...
import { bindScopeParent, carrierKeyOf, createScope, isScopeCarrier, scopeChainOf, scopeOf, scopeParentOf, scopeTarget } from '@teoclub/harness-scope'
import type { Scope, Scoped } from '@teoclub/harness-scope'
