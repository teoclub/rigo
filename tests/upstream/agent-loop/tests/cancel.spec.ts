...
import { CallId, createUserMessage } from '@teoclub/harness-llm'
/**
...
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED_BEFORE_DISPATCH } from '@teoclub/harness-tools'
...
describe('Agent.cancel()', () => {
  ...
  it('idle-listener cancellation settles its waiter without cancelling later work', async () => {
    ...
    await expect(Promise.resolve(Promise.race([
