...
import SystemPrompt, { AssembleContext, PromptAssembly, renderContextSnapshot, renderPrompt } from '@teoclub/harness-system-prompt'
...
describe('SystemPrompt', () => {
  ...
  it('rejects multiple effective complete sections', async () => {
    ...
    await expect(Promise.resolve(ctx.systemPrompt.assemble()))
