...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@teoclub/harness-llm'
import type { AppIdentity } from '@teoclub/harness-llm'

const manifest = createRequire(import.meta.url)('../../../../packages/harness/llm/package.json') as { version: string }
