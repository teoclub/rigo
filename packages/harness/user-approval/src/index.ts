...
import { createUserMessage, type CallId } from '@teoclub/harness-llm'
import { scopeTarget } from '@teoclub/harness-scope'
import type { Scoped } from '@teoclub/harness-scope'
import type { Session, SessionEvent } from '@teoclub/harness-session'
...
declare module '@teoclub/harness-session/types' {
