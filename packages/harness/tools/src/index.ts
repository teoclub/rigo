...
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeOf, scopeTarget } from '@teoclub/harness-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@teoclub/harness-scope'
import type { CallId, ContentBlock, ToolSchema } from '@teoclub/harness-llm'
import { assertNever, deepFreeze, HarnessError } from '@teoclub/harness-llm'
import type { Agent } from '@teoclub/harness-agent'
import { snapshotJsonValue } from '@teoclub/harness-session'
import type { JsonValue, UserMessage } from '@teoclub/harness-session'
import type { ToolProviderResult } from '@teoclub/harness-system-prompt'
import type { CodeRuntime } from '@teoclub/harness-code-runtime'
// Type-only: makes `ctx.get('approval')` resolve to the ApprovalService
// augmentation. The seam stays optional at runtime — see `serviceAsk`.
import type {} from '@teoclub/harness-user-approval'
...
export type { JsonValue } from '@teoclub/harness-session'
