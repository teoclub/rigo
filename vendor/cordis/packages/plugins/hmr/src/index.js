import { Service } from '@teoclub/cordis';
...
import { isBun } from "./engine/shared.js";
import { safeRestart } from "./engine/bun.js";
import { loadDependencies } from "./engine/node.js";
...
class Hmr extends Service {
    ...
    async _resolve(specifier, parentURL, attrs) {
        ...
        if (this._resolveSyncShape === undefined) {
            ...
            // throwing.
            try {
                const probe = internal.resolveSync('node:events', 'file:///', {});
        ...
        if (this._resolveSyncShape === 'classic') {
            return internal.resolveSync(specifier, parentURL, attrs);
        }
    ...
    async *[Service.init]() {
        ...
        const fullRestart = this.ctx.debounce((url) => safeRestart(this.ctx, this.ctx.loader, { url }), this.config.debounce);
