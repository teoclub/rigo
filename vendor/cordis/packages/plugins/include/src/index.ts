import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@teoclub/cordis-plugin-loader'
...
export class Include extends EntryTree {
  ...
  async* [Service.init]() {
    ...
    try {
      ...
      if (!(error instanceof ConfigFileError) || error.stage !== 'read' || (error.cause as { code?: string } | undefined)?.code !== 'ENOENT') throw error
